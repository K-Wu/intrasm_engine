# TODO: implement alternate layers
# Based on https://github.com/huggingface/transformers/blob/03cc17775b961d16cc4d0d7ab0c8487120d0b708/src/transformers/models/llama/modeling_llama.py
# coding=utf-8
...
def _expand_mask(
    ...
    warnings.warn(
        ...
        " is deprecated and will be removed in v4.37. Use"
...
def _make_causal_mask(
    ...
    warnings.warn(
        "Calling `transformers.models.llama.modeling_llama._make_causal_mask`"
        " is deprecated and will be removed in v4.37. Use"
    ...
    def __init__(self, config: LlamaConfig, layer_idx: Optional[int] = None):
        ...
        if layer_idx is None:
            logger.warning_once(
                ...
                " `layer_idx` is not recommended and will lead to errors"
        ...
        if (self.head_dim * self.num_heads) != self.hidden_size:
            raise ValueError(
                ...
                f" `hidden_size`: {self.hidden_size} and `num_heads`:"
                f" {self.num_heads})."
            )
        ...
        if past_key_value is not None:
            if self.layer_idx is None:
                raise ValueError(
                    ...
                    f" you are using {self.__class__.__name__} for"
                    " auto-regressive decoding with k/v caching, please make"
                    " sure to initialize the attention class with a layer"
                    " index."
                )
        ...
        **kwargs,
        ...
        if input_dtype == torch.float32:
            ...
            logger.warning_once(
                ...
                " float32, this might be related to the fact you have"
                " upcasted embedding or layer norm layers in float32. We will"
                f" cast back the input in {target_dtype}."
            )
    ...
    def forward(
        ...
        if output_attentions:
            ...
            logger.warning_once(
                ...
                " attention implementation, but specifying the manual"
                " implementation will be required from Transformers version"
                " v5.0.0 onwards. This warning can be removed using the"
...
@add_start_docstrings(
    (
        "The bare LLaMA Model outputting raw hidden-states without any"
