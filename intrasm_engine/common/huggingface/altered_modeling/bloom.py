...
# Based on https://github.com/huggingface/transformers/blob/03cc17775b961d16cc4d0d7ab0c8487120d0b708/src/transformers/models/bloom/modeling_bloom.py
# coding=utf-8
...
class BloomPreTrainedModel(PreTrainedModel):
    ...
    def _convert_to_bloom_cache(
        ...
        """
        batch_size, num_heads, head_dim, seq_length = past_key_value[0][
            0
        ].shape
...
@add_start_docstrings(
    (
        "The bare Bloom Model transformer outputting raw hidden-states without"
    ...
    def forward(
        ...
        **deprecated_arguments,
        ...
        if deprecated_arguments.pop("position_ids", False) is not False:
            ...
            warnings.warn(
                (
                    "`position_ids` have no functionality in BLOOM and will be"
                    " removed in v5.0.0. You can safely ignore passing"
                    " `position_ids`."
                ),
                FutureWarning,
            )
...
class BloomForTokenClassification(BloomPreTrainedModel):
    def __init__(self, config: BloomConfig):
        ...
        if (
            ...
            hasattr(config, "hidden_dropout")
            and config.hidden_dropout is not None
        ):
